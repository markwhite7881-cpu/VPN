...
if (-not (Test-Path -LiteralPath $packageJsonPath -PathType Leaf)) {
    throw "Package manifest is missing: $packageJsonPath"
}

try {
    $packageJson = Get-Content -LiteralPath $packageJsonPath -Raw -Encoding UTF8 | ConvertFrom-Json
} catch {
    throw "Package manifest is not valid JSON: $packageJsonPath"
}
...
if ($packageVersion -ne $version) {
    throw "Package version '$packageVersion' must match canonical Tauri version '$version'."
}
...
$propertiesHeader = '// THIS IS AN AUTOGENERATED FILE. DO NOT EDIT THIS FILE DIRECTLY.'
$expectedContent = "$propertiesHeader`ntauri.android.versionName=$version`ntauri.android.versionCode=$versionCode`n"
