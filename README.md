...
**Режим «Через VPN».** Выберите браузер, игру, мессенджер или другое приложение — только их соединения пойдут через VPN-туннель. Остальной трафик продолжит работать напрямую.

**Режим «Исключения».** Можно сделать наоборот: направить через VPN весь системный трафик и оставить прямое подключение только для выбранных приложений — например, банковских клиентов, корпоративных сервисов или программ в локальной сети.
