...
Режим «исключения». Можно сделать наоборот: направить через VPN весь трафик системы, а выбранные приложения — например, банки, корпоративные сервисы или локальные программы — оставить на прямом подключении.
